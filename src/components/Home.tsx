    ...
    return (
        <main className="text-center flex flex-col items-center">
            <div className='flex flex-col items-center w-full max-w-4xl gap-6 mt-52 px-2 sm:px-4'>
                ...
                <button onClick={startHandler} className='tracking-wider font-medium uppercase py-3 px-16 bg-indigo-600 rounded text-white shadow-lg shadow-indigo-900 ease-in-out duration-300 hover:bg-white hover:text-indigo-700'>Start</button>
            </div>
        </main>
