    ...
    return (
        <>
            ...
            <ul className={`${isOpen ? 'fixed top-0 min-h-screen z-30 w-full bg-white ease-in-out duration-300' : 'fixed -top-full min-h-screen z-10 w-full bg-white ease-in-out duration-300'} flex flex-col justify-center items-center gap-4 md:top-0 md:flex-row md:min-h-fit md:py-4 md:relative md:max-w-7xl md:w-full md:px-4 md:bg-transparent md:border md:border-b-slate-200 md:border-t-0 md:gap-0`}>
                <li className='w-full'><a href="#" className='text-2xl font-medium uppercase tracking-wider flex justify-center py-2 ease-out duration-300 hover:bg-gray-300 md:text-white md:hover:bg-indigo-400 md:capitalize'>Home</a></li>
                <li className='w-full'><a href="#" className='text-2xl font-medium uppercase tracking-wider flex justify-center py-2 ease-out duration-300 hover:bg-gray-300 md:text-white md:hover:bg-indigo-400 md:capitalize'>planning</a></li>
                <li className='w-full'><a href="#" className='text-2xl font-medium uppercase tracking-wider flex justify-center py-2 ease-out duration-300 hover:bg-gray-300 md:text-white md:hover:bg-indigo-400 md:capitalize'>week's schedule</a></li>
            </ul>
        </>
    )
}
